...
#Region " Properties "
    ...
    Private _OverrideMaxValue As Single = 100000.0F
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If _Values.Count > 1 Then
            ...
            If _DrawHoverData AndAlso Not (Index < 0) Then
                ...
                SS = G.MeasureString(GetFileSize(SB), Font).ToSize()
                ...
                G.DrawString(GetFileSize(SB), Font, _HoverLabelForeColor, New Point(R3.X + 10, R3.Y + 5))
            End If
